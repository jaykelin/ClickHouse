...
struct MergeTreeSettings
{
    ...
    /// Maximum number of days for recent data save as daily partition
    size_t max_days_to_save_daily_partition = 30;
    ...
    #define SET(NAME, GETTER) \
        ...
        SET(max_days_to_save_daily_partition, getUInt64);
